...
public class MainPanel extends JPanel {
    ...
    private void addBackground() {
        ...
        back.setColor(0.17f, 0.65f, 0.92f); // 青い空
    ...
    private void addSphere() {
        Color3f black = new Color3f(0.0f, 0.0f, 0.0f); // 黒
        Color3f red = new Color3f(1.0f, 0.0f, 0.0f); // 赤
        Color3f specular = new Color3f(0.9f, 0.9f, 0.9f); // ほぼ白
        ...
        t3d.set(new Vector3f(0, 0, 0));  // 原点へ移動するT3D

        // 移動や回転用のノードがTG（T3Dをセットして使う）
        TransformGroup tg = new TransformGroup(t3d);
        // 球を作成
        Sphere sphere = new Sphere(2.0f, Sphere.GENERATE_NORMALS, 100, blueApp);
        tg.addChild(sphere);  // 移動用TGに球を接続する！
